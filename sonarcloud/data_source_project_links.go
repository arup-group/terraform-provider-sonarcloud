...
var _ datasource.DataSource = &dataSourceProjectLinks{}

func (d *dataSourceProjectLinks) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_project_links"
}

func (d *dataSourceProjectLinks) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
