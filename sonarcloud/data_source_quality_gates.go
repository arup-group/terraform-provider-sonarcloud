...
var _ datasource.DataSource = &dataSourceQualityGates{}

func (d *dataSourceQualityGates) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_quality_gates"
}

func (d *dataSourceQualityGates) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
