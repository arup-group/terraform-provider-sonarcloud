...
var _ datasource.DataSource = &dataSourceQualityGate{}

func (d *dataSourceQualityGate) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_quality_gate"
}

func (d *dataSourceQualityGate) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
